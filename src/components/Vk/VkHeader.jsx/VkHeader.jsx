...
import s from './VkHeader.module.scss'
    ...
    return(
        <div className={s.header}>
                <div className={s.container}>
                    ...
                    <div className={s.noti_btn}><span>7</span></div>
                    <div className={s.music_btn}></div>
                    <div className={s.user_assets}>
                        <p>Кирилл</p>
                        <img src="https://s.starladder.com/uploads/user_logo/7/2/a/1/meta_tag_0e770e377010c70b7c7418dd394cbf2f.png" alt="user_header_img"/>
